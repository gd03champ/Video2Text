...
def main(v_path):
    ...
    parser.add_argument("-v", "--video", help="The input video file for the text. Default 'video-input.mp4'")
    ...
    command = "ffmpeg -i "+videoFile+" -ab 160k -ac 2 -ar 44100 -vn input.wav"
